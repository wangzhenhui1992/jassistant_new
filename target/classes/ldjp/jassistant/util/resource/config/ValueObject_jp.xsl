...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/root" xml:space="default">
		...
		====================================================================
		* $Source:
		C:/work/999_CVSRep/jas/source/org/jas/util/resource/config/ValueObject_jp.xsl,v
		$
		* $Author: zhangxj $
		* $Revision: 1.1 $
		...
		*/
		...
		<xsl:if test="count(import_class_define/item) &gt; 0"
			xml:space="preserve">

		</xsl:if>

		<xsl:for-each select="import_class_define/item"
			xml:space="preserve">
			<xsl:value-of select="." />
		</xsl:for-each>
		/**
