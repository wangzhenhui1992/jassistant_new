...
public class DialogSelectColumns extends PJDialogBase {
	...
	public DialogSelectColumns() {
		this(Main.getMDIMain(), WordManager.getWord(WordKeyConsts.W0124), true);
	}
	 ...
	 * initialize columns
	 */
	void initResources(Vector<String> columnVector, boolean[] showColumnFlags) {
		for (int i = 0; i < columnVector.size(); i++) {
			JCheckBox oneCmbColumn = new JCheckBox(columnVector.get(i));
