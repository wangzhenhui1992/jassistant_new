...
public class DialogFilterSort extends PJDialogBase {
	...
	ImageIcon iconRemoveSort = ImageManager.createImageIcon(PJConst.IMAGE_REMOVESORT);
	ImageIcon iconAddSort = ImageManager.createImageIcon(PJConst.IMAGE_ADDSORT);
	ImageIcon iconMoveSortUp = ImageManager.createImageIcon(PJConst.IMAGE_MOVESORTUP);
	ImageIcon iconMoveSortDown = ImageManager.createImageIcon(PJConst.IMAGE_MOVESORTDOWN);
	...
	public DialogFilterSort() {
		this(Main.getMDIMain(), WordManager.getWord(WordKeyConsts.W0039), true);
	}
	...
	void jbInit() throws Exception {
		...
		btnClearSort.setText(WordManager.getWord(WordKeyConsts.W0040));
		btnClearSort.setMnemonic(PJConst.MNEMONIC_S);
		...
		this.setTitle(WordManager.getWord(WordKeyConsts.W0039));
		...
		btnClearFilter.setText(WordManager.getWord(WordKeyConsts.W0040));
		btnClearFilter.setMnemonic(PJConst.MNEMONIC_F);
		...
		btnSortASCAdd.setText(WordManager.getWord(WordKeyConsts.W0041));
		...
		btnSortDESCAdd.setText(WordManager.getWord(WordKeyConsts.W0042));
		...
		btnAddLeftBrace.setText(WordManager.getWord(WordKeyConsts.W0043));
		...
		btnAddtoFilter.setText(WordManager.getWord(WordKeyConsts.W0044));
		...
		btnAndIntoFilter.setText(WordManager.getWord(WordKeyConsts.W0045));
		btnOrIntoFilter.setToolTipText(WordManager.getWord(WordKeyConsts.W0046));
		...
		btnOrIntoFilter.setText(WordManager.getWord(WordKeyConsts.W0047));
		btnOrIntoFilter.setToolTipText(WordManager.getWord(WordKeyConsts.W0048));
		...
		btnAddRightBrace.setText(WordManager.getWord(WordKeyConsts.W0049));
		this.getContentPane().add(panelMain,  BorderLayout.CENTER);
		panelMain.add(panelTop, BorderLayout.NORTH);
		panelMain.add(panelCenter,  BorderLayout.CENTER);
		panelCenter.add(tabbedPaneCenter, BorderLayout.CENTER);
		tabbedPaneCenter.add(panelSort,  WordManager.getWord(WordKeyConsts.W0050));
		...
		tabbedPaneCenter.add(panelFilter,  WordManager.getWord(WordKeyConsts.W0051));
    ...
    public void initResources(Vector<?> columns, String tableName) {
		...
		// init sorted columns
		Vector<Object> orgSort = FilterSortManager.getSortVector(connURL, tableName);
		if (orgSort != null) {
			orgSort = (Vector<Object>) orgSort.clone();
		}
		lstSortSortedColumnsModel.resetData(orgSort);

		// init orginal columns
		Vector<Object> orgColumns = (Vector<Object>) columns.clone();
		if (orgSort != null) {
    ...
    void updateFilterSort() {
		Vector<Object> sortData = lstSortSortedColumnsModel.getData();
		String filter = txtFilterScript.getText();
		String connURL = Main.getMDIMain().currentConnURL;

		if (sortData != null) {
			sortData = (Vector<Object>) sortData.clone();
		}
    ...
    void btnClearSort_actionPerformed(ActionEvent e) {
		...
		lstSortOrgColumnsModel.resetData((Vector<Object>) orginalVector.clone());
	...
	void btnClearFilter_actionPerformed(ActionEvent e) {
		txtFilterScript.setText(PJConst.EMPTY);
	}
	...
	void addText(String text, boolean wrap) {
		...
		if (wrap) {
			if (StringUtil.isEmptyWithTrim(txtFilterScript.getText())) {
	...
	void btnRemoveSort_actionPerformed(ActionEvent e) {
		...
		if (!StringUtil.isEmpty(selectColumn)) {
