...
public class StringUtil {
	...
	public static String getPadZeroString(String str, int len) {
		if (isEmpty(str)) return PJConst.EMPTY;
		if (str.length() >= len) return str;
		StringBuffer sb = new StringBuffer(PJConst.EMPTY);
	 ...
	 *
	 */
    public static Class<?> getJavaTypeBySQLType(int sqlType, int index,
	 ...
	 */
    public static Object getConvertValueOfType(Class<?> javaType, Object value)
            throws Exception {
		if (value == null || value.equals(PJConst.EMPTY)) {
			return null;
		}
    ...
    public static Object getIncreaseConvertValueOfType(Class<?> javaType, Object value,
            int i, int totalLen) throws Exception {
		try {
			if (javaType == String.class) {
	 ...
	 */
	public static ArrayList<String> getListFromString(String str, String sep) {
		if (isEmpty(str)) {
			return null;
		}
	 ...
	 *
	 */
    public static String joinList(Vector<Object> rowVector, Vector<Class<?>> typeVector,
            char sep, boolean isNeedQuotation) {
		StringBuffer sb = new StringBuffer();

		for (int i = 0; i < typeVector.size(); i++) {
			sb.append(nvl(getStringValue(typeVector.get(i), rowVector.get(i), isNeedQuotation)));
	 ...
	 *
	 */
    public static String joinHtmlString(Vector<String> columnNameVector,
            Vector<Object> dataVector, Vector<Class<?>> typeVector,
            Vector<Integer> sizeVector, boolean isHeader) {
		StringBuffer sb = new StringBuffer();
		...
		sb.append("<tr>");
		for (int i = 0; i < typeVector.size(); i++) {
			sb.append("<" + tagCell + " width=" + getTDWidthSize(typeVector.get(i), ((Integer) sizeVector.get(i)).intValue()) + ">");
			if (isHeader) {
				sb.append(columnNameVector.get(i));
			} else {
				sb.append(parseHtmlString(getStringValue(typeVector.get(i), dataVector.get(i))));
			}
			sb.append("</" + tagCell + ">");
		}
		sb.append("</tr>");
	 ...
	 *
	 */
    public static String joinSqlString(Vector<String> nameVector,
            Vector<Object> dataVector, Vector<Class<?>> typeVector,
            Vector<Integer> sizeVector, String tableName, String driverName) {
		StringBuffer sb = new StringBuffer();
	 ...
	 * @param content
	 */
	public static ArrayList<Object> getHtmlFormFieldName(String content) {
	 ...
	 * @param content
	 */
	public static ArrayList<Object> getStrutsFormFieldName(String content) {
		ArrayList<Object> retArrayList = new ArrayList<Object>();
	 ...
	 * @param content
	 */
	public static ArrayList<String> getFormFieldName(String content, String tag, String name) {
	...
	public static Class<?> getSimpleJavaType(int sqlType){
    ...
    public static boolean isEmpty(String str) {
        return str == null || str.equals(PJConst.EMPTY);
    }

    public static boolean isEmptyWithTrim(String str) {
        return trim(str).equals(PJConst.EMPTY);
    }

    public static String trim(String str){
        return str == null ? PJConst.EMPTY : str.trim();
    }
}
