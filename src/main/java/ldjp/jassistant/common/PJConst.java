...
public interface PJConst extends Serializable {
	...
	/**
	 * the define of properties
	 */
    public static final String DEFAULT_CONFIG_DIR = "./config/";
    public static final String DEFAULT_CONFIGFILE_PATH = "/ldjp/jassistant/util/resource/config/configuration.properties";
    public static final String DEFAULT_TEMPLATEFILE_JA_PATH = "/ldjp/jassistant/util/resource/config/databean_template_ja.properties";
    public static final String DEFAULT_TEMPLATEFILE_CN_PATH = "/ldjp/jassistant/util/resource/config/databean_template_cn.properties";
    public static final String DEFAULT_TEMPLATEFILE_EN_PATH = "/ldjp/jassistant/util/resource/config/databean_template_en.properties";

    public static final String HELP_CONTENT = "/ldjp/jassistant/util/resource/help/help.txt";
    public static final String HELP_IMAGE_DIR = "/ldjp/jassistant/util/resource/help/images/";

    public static final String DEFAULT_MESSAGEFILE_JA_PATH = "ldjp.jassistant.util.resource.messages.japanese";
    public static final String DEFAULT_MESSAGEFILE_CN_PATH = "ldjp.jassistant.util.resource.messages.chinese";
    public static final String DEFAULT_MESSAGEFILE_EN_PATH = "ldjp.jassistant.util.resource.messages.english";

    public static final String DEFAULT_WORDFILE_JA_PATH = "ldjp.jassistant.util.resource.word.word_japanese";
    public static final String DEFAULT_WORDFILE_CN_PATH = "ldjp.jassistant.util.resource.word.word_chinese";
    public static final String DEFAULT_WORDFILE_EN_PATH = "ldjp.jassistant.util.resource.word.word_english";
	...
	public static final String IMAGE_IMPROTFILE = "importfile.gif";
	public static final String IMAGE_EXPROTFILE = "exporttofile.gif";
	public static final String IMAGE_REFRESHTABLE = "refreshtable.gif";
	public static final String IMAGE_REMOVESORT = "removesort.gif";
	public static final String IMAGE_ADDSORT = "addsort.gif";
	public static final String IMAGE_MOVESORTUP = "movesortup.gif";
	public static final String IMAGE_MOVESORTDOWN = "movesortdown.gif";


	public static final char MNEMONIC_A = 'A';
	public static final char MNEMONIC_B = 'B';
	public static final char MNEMONIC_C = 'C';
	public static final char MNEMONIC_D = 'D';
	public static final char MNEMONIC_E = 'E';
	public static final char MNEMONIC_F = 'F';
	public static final char MNEMONIC_H = 'H';
	public static final char MNEMONIC_N = 'N';
	public static final char MNEMONIC_O = 'O';
	public static final char MNEMONIC_R = 'R';
	public static final char MNEMONIC_S = 'S';
	public static final char MNEMONIC_V = 'V';
	public static final char MNEMONIC_W = 'W';
